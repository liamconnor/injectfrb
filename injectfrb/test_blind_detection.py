...
class TestDetectionDecision(unittest.TestCase):
	...
	def test_dm_time_box(self):
		...
		decision2 = DD.dm_time_box_decision(101., 1924.01, t_err=1e-3)
	...
	def test_three_decision_methods(self):
		...
		decision1 = DD.dm_time_contour_decision(1000., 42., dmtarr_function='bowtie', simulator='injectfrb')
		decision2 = DD.dm_time_contour_decision(1000., 42., dmtarr_function='box', simulator='injectfrb')
		decision3 = DD.dm_time_contour_decision(1000., 42., dmtarr_function='gaussian', simulator='injectfrb')

		self.assertTrue(decision1)
		self.assertTrue(decision2)
		self.assertTrue(decision3)

		decision1 = DD.dm_time_contour_decision(1000., 33., dmtarr_function='bowtie', simulator='injectfrb')
		decision2 = DD.dm_time_contour_decision(1000., 50., dmtarr_function='box', simulator='injectfrb')
		decision3 = DD.dm_time_contour_decision(1000., 15., dmtarr_function='gaussian', simulator='injectfrb')
